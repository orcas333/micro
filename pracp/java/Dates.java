...
public final class Dates {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return Dates.internal_static_Date_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return Dates.internal_static_Date_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              Dates.Date.class, Dates.Date.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof Dates.Date)) {
        return super.equals(obj);
      }
      Dates.Date other = (Dates.Date) obj;
    ...
    public static Dates.Date parseFrom(
    ...
    public static Dates.Date parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Dates.Date parseFrom(
    ...
    public static Dates.Date parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Dates.Date parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Dates.Date parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Dates.Date prototype) {
    ...
    public static final class Builder extends
      ...
      // Construct using Dates.Date.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public Dates.Date getDefaultInstanceForType() {
        return Dates.Date.getDefaultInstance();
      }

      @java.lang.Override
      public Dates.Date build() {
        Dates.Date result = buildPartial();
      ...
      @java.lang.Override
      public Dates.Date buildPartial() {
        Dates.Date result = new Dates.Date(this);
        result.year_ = year_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Dates.Date) {
          return mergeFrom((Dates.Date)other);
        } else {
      ...
      public Builder mergeFrom(Dates.Date other) {
        if (other == Dates.Date.getDefaultInstance()) return this;
        if (other.getYear() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Dates.Date parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Dates.Date) e.getUnfinishedMessage();
    ...
    private static final Dates.Date DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Dates.Date();
    }

    public static Dates.Date getDefaultInstance() {
